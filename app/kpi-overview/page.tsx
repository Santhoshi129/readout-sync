    ...
    <>
      ...
      <div className="wrap">
        ...
        <section className="section">
          ...
          <p style={{ color: "var(--ink-faint)", fontSize: 13.5, marginBottom: 16 }}>
            Last 30 days of sync snapshots. Points from failed/partial sync runs (which log as false zeros) are filtered out rather than shown as fake dips.
          </p>
          <div className="card" style={{ padding: 32, marginBottom: 24 }}>
            <div className="eyebrow muted" style={{ marginBottom: 22 }}>Gym owner outreach — contacts &amp; replies</div>
            <Trend
              points={leadHistory}
              series={[
          ...
          <div className="card" style={{ padding: 32 }}>
            <div className="eyebrow muted" style={{ marginBottom: 22 }}>Member app adoption</div>
            <Trend
              points={adoptionHistory}
              series={[
                { key: "total_identified", label: "Identified", tone: "cold" },
                { key: "total_joined", label: "Joined", tone: "hot" },
                { key: "adoption_rate_pct", label: "Adoption rate %", tone: "amber" },
              ]}
            />
          </div>
        </section>
